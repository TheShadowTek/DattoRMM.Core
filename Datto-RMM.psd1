...
FunctionsToExport = @('Connect-DattoRMM', 'Disconnect-RMM', 'Get-RMMAlert', 'Get-RMMDevice', 'Get-RMMFilter', 'Get-RMMPageSize', 'Get-RMMRequestRate', 'Get-RMMsite', 'Get-RMMSiteSettings', 'Get-RMMUser', 'Get-RMMVariable', 'Set-RMMPageSize')
