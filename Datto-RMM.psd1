...
FunctionsToExport = @('Connect-DattoRMM', 'Disconnect-RMM', 'Get-RMMAlert', 'Get-RMMDevice', 'Get-RMMFilter', 'Get-RMMRequestRate', 'Get-RMMsite', 'Get-RMMSiteSettings', 'Get-RMMVariable')
