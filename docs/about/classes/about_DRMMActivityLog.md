...
DRMMActivityLog objects are returned by [Get-RMMActivityLog](Get-RMMActivityLog.md), which retrieves activity log entries for audit and event tracking. Use Get-RMMActivityLog to list, filter, and analyse activity logs programmatically.
