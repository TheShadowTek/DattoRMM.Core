...
| [`DRMMActivityLogDetailsUserAccount`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAccount.md) | Base class for USER account-related activity log details, containing properties common to all account actions. |
| [`DRMMActivityLogDetailsUserAccountGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAccountGeneric.md) | Represents a generic USER account activity log details for unknown account actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserAccountChangeSettings`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAccountChangeSettings.md) | Represents an activity log of entity USER, category account, and action change |
| [`DRMMActivityLogDetailsUserAccountLogin`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAccountLogin.md) | Represents an activity log of entity USER, category account, and action login, which includes specific properties related to user login activities. |
| [`DRMMActivityLogDetailsUserAccountLogout`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAccountLogout.md) | Represents an activity log of entity USER, category account, and action logout. |
| [`DRMMActivityLogDetailsUserAccountUpdate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAccountUpdate.md) | Represents an activity log of entity USER, category account, and action update, with dynamic properties for the fields that were changed. |
| [`DRMMActivityLogDetailsUserComponent`](DRMMActivityLog/about_DRMMActivityLogDetailsUserComponent.md) | Base class for USER component-related activity log details, containing properties common to all component actions. |
| [`DRMMActivityLogDetailsUserComponentGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserComponentGeneric.md) | Represents a generic USER component activity log details for unknown component actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserComponentAddFromComstore`](DRMMActivityLog/about_DRMMActivityLogDetailsUserComponentAddFromComstore.md) | Represents an activity log of entity USER, category component, and action add |
| [`DRMMActivityLogDetailsUserComponentCreate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserComponentCreate.md) | Represents an activity log of entity USER, category component, and action create. |
| [`DRMMActivityLogDetailsUserComponentDelete`](DRMMActivityLog/about_DRMMActivityLogDetailsUserComponentDelete.md) | Represents an activity log of entity USER, category component, and action delete. |
| [`DRMMActivityLogDetailsUserComponentUpdate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserComponentUpdate.md) | Represents an activity log of entity USER, category component, and action update, which includes an additional security level property. |
| [`DRMMActivityLogDetailsUserDevice`](DRMMActivityLog/about_DRMMActivityLogDetailsUserDevice.md) | Base class for USER device-related activity log details, containing properties common to all device actions. |
| [`DRMMActivityLogDetailsUserDeviceGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserDeviceGeneric.md) | Represents a generic USER device activity log details for unknown device actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserDeviceEdit`](DRMMActivityLog/about_DRMMActivityLogDetailsUserDeviceEdit.md) | Represents an activity log of entity USER, category device, and action edit, with dynamic properties for the fields that were changed. |
| [`DRMMActivityLogDetailsUserDeviceMoveDevice`](DRMMActivityLog/about_DRMMActivityLogDetailsUserDeviceMoveDevice.md) | Represents an activity log of entity USER, category device, and action move |
| [`DRMMActivityLogDetailsUserDeviceApproved`](DRMMActivityLog/about_DRMMActivityLogDetailsUserDeviceApproved.md) | Represents an activity log of entity USER, category device, and action approved, which identifies the devices that were approved. |
| [`DRMMActivityLogDetailsUserDeviceDelete`](DRMMActivityLog/about_DRMMActivityLogDetailsUserDeviceDelete.md) | Represents an activity log of entity USER, category device, and action delete, which identifies the devices that were deleted. |
| [`DRMMActivityLogDetailsUserDeviceRemove`](DRMMActivityLog/about_DRMMActivityLogDetailsUserDeviceRemove.md) | Represents an activity log of entity USER, category device, and action remove, which identifies the devices that were removed. |
| [`DRMMActivityLogDetailsUserMonitor`](DRMMActivityLog/about_DRMMActivityLogDetailsUserMonitor.md) | Base class for USER monitor-related activity log details, containing properties common to all monitor actions. |
| [`DRMMActivityLogDetailsUserMonitorGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserMonitorGeneric.md) | Represents a generic USER monitor activity log details for unknown monitor actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserMonitorCreate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserMonitorCreate.md) | Represents an activity log of entity USER, category monitor, and action create, which includes specific properties related to monitor creation activities. |
| [`DRMMActivityLogDetailsUserMonitorEdit`](DRMMActivityLog/about_DRMMActivityLogDetailsUserMonitorEdit.md) | Represents an activity log of entity USER, category monitor, and action edit, which includes specific properties related to monitor edit activities. |
| [`DRMMActivityLogDetailsUserMonitorResolveAlert`](DRMMActivityLog/about_DRMMActivityLogDetailsUserMonitorResolveAlert.md) | Represents an activity log of entity USER, category monitor, and action resolve |
| [`DRMMActivityLogDetailsUserSite`](DRMMActivityLog/about_DRMMActivityLogDetailsUserSite.md) | Base class for USER site-related activity log details, containing properties common to all site actions. |
| [`DRMMActivityLogDetailsUserSiteGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserSiteGeneric.md) | Represents a generic USER site activity log details for unknown site actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserSiteCreate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserSiteCreate.md) | Represents an activity log of entity USER, category site, and action create, which includes specific properties related to site creation activities. |
| [`DRMMActivityLogDetailsUserSiteDelete`](DRMMActivityLog/about_DRMMActivityLogDetailsUserSiteDelete.md) | Represents an activity log of entity USER, category site, and action delete, which identifies the site that was deleted. |
| [`DRMMActivityLogDetailsUserSiteEdit`](DRMMActivityLog/about_DRMMActivityLogDetailsUserSiteEdit.md) | Represents an activity log of entity USER, category site, and action edit, with known site properties and dynamic overflow for additional fields. |
| [`DRMMActivityLogDetailsUserSiteChangeSettings`](DRMMActivityLog/about_DRMMActivityLogDetailsUserSiteChangeSettings.md) | Represents an activity log of entity USER, category site, and action change |
| [`DRMMActivityLogDetailsUserSiteUpdate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserSiteUpdate.md) | Represents an activity log of entity USER, category site, and action update, with dynamic properties for the fields that were updated. |
| [`DRMMActivityLogDetailsUserUser`](DRMMActivityLog/about_DRMMActivityLogDetailsUserUser.md) | Base class for USER user-related activity log details, containing properties common to all user management actions. |
| [`DRMMActivityLogDetailsUserUserGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserUserGeneric.md) | Represents a generic USER user activity log details for unknown user management actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserUserEdit`](DRMMActivityLog/about_DRMMActivityLogDetailsUserUserEdit.md) | Represents an activity log of entity USER, category user, and action edit, which includes specific properties related to user account edit activities. |
| [`DRMMActivityLogDetailsUserUserGenerateApiKeys`](DRMMActivityLog/about_DRMMActivityLogDetailsUserUserGenerateApiKeys.md) | Represents an activity log of entity USER, category user, and action generate |
| [`DRMMActivityLogDetailsUserUserCreate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserUserCreate.md) | Represents an activity log of entity USER, category user, and action create, which includes properties describing the user account that was created. |
| [`DRMMActivityLogDetailsUserAuthUser`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAuthUser.md) | Base class for USER authUser-related activity log details, containing properties common to all authUser actions. |
| [`DRMMActivityLogDetailsUserAuthUserGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAuthUserGeneric.md) | Represents a generic USER authUser activity log details for unknown authUser actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserAuthUserGenerateApiKeys`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAuthUserGenerateApiKeys.md) | Represents an activity log of entity USER, category authUser, and action generate |
| [`DRMMActivityLogDetailsUserBranding`](DRMMActivityLog/about_DRMMActivityLogDetailsUserBranding.md) | Base class for USER branding-related activity log details, containing properties common to all branding actions. |
| [`DRMMActivityLogDetailsUserBrandingGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserBrandingGeneric.md) | Represents a generic USER branding activity log details for unknown branding actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserBrandingPushChanges`](DRMMActivityLog/about_DRMMActivityLogDetailsUserBrandingPushChanges.md) | Represents an activity log of entity USER, category branding, and action push |
| [`DRMMActivityLogDetailsUserEmailRecipient`](DRMMActivityLog/about_DRMMActivityLogDetailsUserEmailRecipient.md) | Base class for USER email |
| [`DRMMActivityLogDetailsUserEmailRecipientGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserEmailRecipientGeneric.md) | Represents a generic USER email |
| [`DRMMActivityLogDetailsUserEmailRecipientUpdate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserEmailRecipientUpdate.md) | Represents an activity log of entity USER, category email |
| [`DRMMActivityLogDetailsUserAgent`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAgent.md) | Base class for USER agent-related activity log details, containing properties common to all agent session actions. |
| [`DRMMActivityLogDetailsUserAgentGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAgentGeneric.md) | Represents a generic USER agent activity log details for unknown agent actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserAgentEvent`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAgentEvent.md) | Represents an activity log of entity USER, category agent, and action event, which includes specific properties related to agent event activities. |
| [`DRMMActivityLogDetailsUserAgentFile`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAgentFile.md) | Represents an activity log of entity USER, category agent, and action file, which includes specific properties related to agent file transfer activities. |
| [`DRMMActivityLogDetailsUserAgentRs`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAgentRs.md) | Represents an activity log of entity USER, category agent, and action rs (remote support), which includes specific properties related to agent remote support activities. |
| [`DRMMActivityLogDetailsUserAgentShot`](DRMMActivityLog/about_DRMMActivityLogDetailsUserAgentShot.md) | Represents an activity log of entity USER, category agent, and action shot (screenshot), which includes specific properties related to agent screenshot activities. |
| [`DRMMActivityLogDetailsUserPolicy`](DRMMActivityLog/about_DRMMActivityLogDetailsUserPolicy.md) | Base class for USER policy-related activity log details, containing properties common to all policy actions. |
| [`DRMMActivityLogDetailsUserPolicyGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserPolicyGeneric.md) | Represents a generic USER policy activity log details for unknown policy actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserPolicyCreateAndPushChanges`](DRMMActivityLog/about_DRMMActivityLogDetailsUserPolicyCreateAndPushChanges.md) | Represents an activity log of entity USER, category policy, and action create |
| [`DRMMActivityLogDetailsUserPolicyEdit`](DRMMActivityLog/about_DRMMActivityLogDetailsUserPolicyEdit.md) | Represents an activity log of entity USER, category policy, and action edit, which includes specific properties related to policy edit activities. |
| [`DRMMActivityLogDetailsUserPolicyEditAndPushChanges`](DRMMActivityLog/about_DRMMActivityLogDetailsUserPolicyEditAndPushChanges.md) | Represents an activity log of entity USER, category policy, and action edit |
| [`DRMMActivityLogDetailsUserPolicyToggle`](DRMMActivityLog/about_DRMMActivityLogDetailsUserPolicyToggle.md) | Represents an activity log of entity USER, category policy, and action toggle, which includes specific properties related to policy toggle activities. |
| [`DRMMActivityLogDetailsUserPolicyDelete`](DRMMActivityLog/about_DRMMActivityLogDetailsUserPolicyDelete.md) | Represents an activity log of entity USER, category policy, and action delete. |
| [`DRMMActivityLogDetailsUserFilter`](DRMMActivityLog/about_DRMMActivityLogDetailsUserFilter.md) | Base class for USER filter-related activity log details, containing properties common to all filter actions. |
| [`DRMMActivityLogDetailsUserFilterGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserFilterGeneric.md) | Represents a generic USER filter activity log details for unknown filter actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserFilterCreate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserFilterCreate.md) | Represents an activity log of entity USER, category filter, and action create, which captures the details of a newly created device filter. |
| [`DRMMActivityLogDetailsUserFilterDelete`](DRMMActivityLog/about_DRMMActivityLogDetailsUserFilterDelete.md) | Represents an activity log of entity USER, category filter, and action delete, which captures the details of a deleted device filter. |
| [`DRMMActivityLogDetailsUserJob`](DRMMActivityLog/about_DRMMActivityLogDetailsUserJob.md) | Base class for USER job-related activity log details, containing properties common to all job actions. |
| [`DRMMActivityLogDetailsUserJobGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserJobGeneric.md) | Represents a generic USER job activity log details for unknown job actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsUserJobCreate`](DRMMActivityLog/about_DRMMActivityLogDetailsUserJobCreate.md) | Represents an activity log of entity USER, category job, and action create, which captures the details of a newly created job. |
| [`DRMMActivityLogDetailsUserJobDelete`](DRMMActivityLog/about_DRMMActivityLogDetailsUserJobDelete.md) | Represents an activity log of entity USER, category job, and action delete, which captures the details of a deleted job. |
| [`DRMMActivityLogDetailsUserJobEdit`](DRMMActivityLog/about_DRMMActivityLogDetailsUserJobEdit.md) | Represents an activity log of entity USER, category job, and action edit, which captures the details of an edited job. |
| [`DRMMActivityLogDetailsUserJobRerun`](DRMMActivityLog/about_DRMMActivityLogDetailsUserJobRerun.md) | Represents an activity log of entity USER, category job, and action rerun, which captures the details of a job that was re-executed against a set of devices. |
| [`DRMMActivityLogDetailsUserJobRetire`](DRMMActivityLog/about_DRMMActivityLogDetailsUserJobRetire.md) | Represents an activity log of entity USER, category job, and action retire, which captures the details of one or more retired jobs. |
| [`DRMMActivityLogDetailsUserWebRemote`](DRMMActivityLog/about_DRMMActivityLogDetailsUserWebRemote.md) | Base class for USER web |
| [`DRMMActivityLogDetailsUserWebRemoteGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserWebRemoteGeneric.md) | Represents a generic USER web |
| [`DRMMActivityLogDetailsUserWebRemoteRto`](DRMMActivityLog/about_DRMMActivityLogDetailsUserWebRemoteRto.md) | Represents an activity log of entity USER, category web |
| [`DRMMActivityLogDetailsUserWebRemoteChat`](DRMMActivityLog/about_DRMMActivityLogDetailsUserWebRemoteChat.md) | Base class for USER web |
| [`DRMMActivityLogDetailsUserWebRemoteChatGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsUserWebRemoteChatGeneric.md) | Represents a generic USER web |
| [`DRMMActivityLogDetailsUserWebRemoteChatSession`](DRMMActivityLog/about_DRMMActivityLogDetailsUserWebRemoteChatSession.md) | Represents an activity log of entity USER, category web |
...
| [`DRMMActivityLogDetailsDevicePatch`](DRMMActivityLog/about_DRMMActivityLogDetailsDevicePatch.md) | Base class for DEVICE patch-related activity log details, containing properties common to all patch actions. |
| [`DRMMActivityLogDetailsDevicePatchGeneric`](DRMMActivityLog/about_DRMMActivityLogDetailsDevicePatchGeneric.md) | Represents a generic DEVICE patch activity log details for unknown patch actions, with base properties and dynamic additional properties. |
| [`DRMMActivityLogDetailsDevicePatchAudit`](DRMMActivityLog/about_DRMMActivityLogDetailsDevicePatchAudit.md) | Represents an activity log of entity DEVICE, category patch, and action audit, which includes specific properties related to patch audit activities. |
