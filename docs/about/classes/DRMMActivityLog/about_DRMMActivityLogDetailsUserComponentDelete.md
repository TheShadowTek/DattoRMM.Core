# about_DRMMActivityLogDetailsUserComponentDelete
...
The DRMMActivityLogDetailsUserComponentDelete class exposes the following properties:

No public properties defined.\n
## METHODS

The DRMMActivityLogDetailsUserComponentDelete class provides the following methods:
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs/about/classes/DRMMActivityLog/about_DRMMActivityLogDetailsUserComponentDelete.md)
