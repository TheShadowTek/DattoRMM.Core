# about_DRMMActivityLogDetailsUserComponentGeneric
...
The DRMMActivityLogDetailsUserComponentGeneric class exposes the following properties:

No public properties defined.\n
## METHODS

The DRMMActivityLogDetailsUserComponentGeneric class provides the following methods:
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs/about/classes/DRMMActivityLog/about_DRMMActivityLogDetailsUserComponentGeneric.md)
