# about_DRMMActivityLogDetailsDeviceRemoteGeneric
...
This class inherits from [DRMMActivityLogDetailsDeviceRemote](./about_DRMMActivityLogDetailsDeviceRemote.md).

## PROPERTIES

The DRMMActivityLogDetailsDeviceRemoteGeneric class exposes the following properties:

No public properties defined.\n
## METHODS

The DRMMActivityLogDetailsDeviceRemoteGeneric class provides the following methods:
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs/about/classes/DRMMActivityLog/about_DRMMActivityLogDetailsDeviceRemoteGeneric.md)
