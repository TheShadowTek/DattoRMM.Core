# about_DRMMActivityLogDetailsUserAccountGeneric
...
This class inherits from [DRMMActivityLogDetailsUserAccount](./about_DRMMActivityLogDetailsUserAccount.md).

## PROPERTIES

The DRMMActivityLogDetailsUserAccountGeneric class exposes the following properties:

No public properties defined.\n
## METHODS

The DRMMActivityLogDetailsUserAccountGeneric class provides the following methods:
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs/about/classes/DRMMActivityLog/about_DRMMActivityLogDetailsUserAccountGeneric.md)
