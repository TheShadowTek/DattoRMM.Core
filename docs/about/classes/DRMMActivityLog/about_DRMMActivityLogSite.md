...
Describes the DRMMActivityLogSite class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMActivityLogSite class represents TODO: describe what this class represents and its purpose.
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs//about/classes/DRMMActivityLog/about_DRMMActivityLogSite.md)
