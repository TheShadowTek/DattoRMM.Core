# about_DRMMActivityLogDetailsDevicePatchGeneric
...
This class inherits from [DRMMActivityLogDetailsDevicePatch](./about_DRMMActivityLogDetailsDevicePatch.md).

## PROPERTIES

The DRMMActivityLogDetailsDevicePatchGeneric class exposes the following properties:

No public properties defined.\n
## METHODS

The DRMMActivityLogDetailsDevicePatchGeneric class provides the following methods:
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs/about/classes/DRMMActivityLog/about_DRMMActivityLogDetailsDevicePatchGeneric.md)
