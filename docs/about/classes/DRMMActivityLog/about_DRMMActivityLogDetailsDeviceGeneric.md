# about_DRMMActivityLogDetailsDeviceGeneric
...
The DRMMActivityLogDetailsDeviceGeneric class exposes the following properties:

No public properties defined.\n
## METHODS

The DRMMActivityLogDetailsDeviceGeneric class provides the following methods:
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs//about/classes/DRMMActivityLog/about_DRMMActivityLogDetailsDeviceGeneric.md)
