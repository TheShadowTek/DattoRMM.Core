...
Describes the DRMMDeviceAuditVideoBoard class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMDeviceAuditVideoBoard class represents TODO: describe what this class represents and its purpose.
...
|----------|------|-------------|
| DisplayAdapter | string | TODO: Add description |\n
## METHODS
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs//about/classes/DRMMDeviceAudit/about_DRMMDeviceAuditVideoBoard.md)
