...
Describes the DRMMAlertContextTemperature class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMAlertContextTemperature class represents TODO: describe what this class represents and its purpose.
...
|----------|------|-------------|
| Degree | float  | TODO: Add description |\n| Type   | string | TODO: Add description |\n
## METHODS
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs//about/classes/DRMMAlert/about_DRMMAlertContextTemperature.md)
