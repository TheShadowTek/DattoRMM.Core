# about_DRMMAlertContextWindowsPerformance

## SHORT DESCRIPTION

Describes the DRMMAlertContextWindowsPerformance class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMAlertContextWindowsPerformance class represents TODO: describe what this class represents and its purpose.
...
The DRMMAlertContextWindowsPerformance class exposes the following properties:

| Property | Type | Description |
|----------|------|-------------|
| Value | float | TODO: Add description |\n
## METHODS
