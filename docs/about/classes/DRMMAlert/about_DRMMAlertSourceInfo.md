...
Describes the DRMMAlertSourceInfo class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMAlertSourceInfo class represents TODO: describe what this class represents and its purpose.
...
|----------|------|-------------|
| DeviceUid  | string | TODO: Add description |\n| DeviceName | string | TODO: Add description |\n| SiteUid    | string | TODO: Add description |\n| SiteName   | string | TODO: Add description |\n
## METHODS
