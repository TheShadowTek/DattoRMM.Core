...
Describes the DRMMAlertContextOnlineOfflineStatus class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMAlertContextOnlineOfflineStatus class represents TODO: describe what this class represents and its purpose.
...
The DRMMAlertContextOnlineOfflineStatus class exposes the following properties:
...
The DRMMAlertContextOnlineOfflineStatus class provides the following methods:
