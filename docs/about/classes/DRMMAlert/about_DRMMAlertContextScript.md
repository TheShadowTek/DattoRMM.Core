...
Describes the DRMMAlertContextScript class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMAlertContextScript class represents TODO: describe what this class represents and its purpose.
...
|----------|------|-------------|
| Samples | hashtable | TODO: Add description |\n
## METHODS
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs//about/classes/DRMMAlert/about_DRMMAlertContextScript.md)
