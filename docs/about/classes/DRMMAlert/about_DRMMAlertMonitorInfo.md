...
Describes the DRMMAlertMonitorInfo class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMAlertMonitorInfo class represents TODO: describe what this class represents and its purpose.
...
|----------|------|-------------|
| SendsEmails   | bool | TODO: Add description |\n| CreatesTicket | bool | TODO: Add description |\n
## METHODS
