...
Describes the DRMMAlertContextPatch class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMAlertContextPatch class represents TODO: describe what this class represents and its purpose.
...
|----------|------|-------------|
| PatchUid  | string | TODO: Add description |\n| PolicyUid | string | TODO: Add description |\n| Result    | string | TODO: Add description |\n| Info      | string | TODO: Add description |\n
## METHODS
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs//about/classes/DRMMAlert/about_DRMMAlertContextPatch.md)
