...
Describes the DRMMJobComponentVariable class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMJobComponentVariable class represents TODO: describe what this class represents and its purpose.
...
The DRMMJobComponentVariable class exposes the following properties:
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs//about/classes/DRMMJob/about_DRMMJobComponentVariable.md)
