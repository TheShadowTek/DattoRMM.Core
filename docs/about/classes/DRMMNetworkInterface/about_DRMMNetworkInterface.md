...
Describes the DRMMNetworkInterface class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMNetworkInterface class represents TODO: describe what this class represents and its purpose.
