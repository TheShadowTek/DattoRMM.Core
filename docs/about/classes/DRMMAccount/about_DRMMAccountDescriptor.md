...
Describes the DRMMAccountDescriptor class used in DattoRMM.Core module.

## LONG DESCRIPTION

The DRMMAccountDescriptor class represents TODO: describe what this class represents and its purpose.
...
|----------|------|-------------|
| BillingEmail | string | TODO: Add description |\n| DeviceLimit  | int    | TODO: Add description |\n| TimeZone     | string | TODO: Add description |\n
## METHODS
...
- [Online Documentation](https://github.com/TheShadowTek/DattoRMM.Core/blob/main/docs//about/classes/DRMMAccount/about_DRMMAccountDescriptor.md)
