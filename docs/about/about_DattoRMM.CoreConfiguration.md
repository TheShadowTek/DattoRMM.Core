...
Controls how aggressively the module manages API request pacing. See [about_DattoRMM.CoreThrottling](about_DattoRMM.CoreThrottling.md) for full details.
...
|---|---|---|---|
| `APIMaxRetries` | Maximum retry attempts for failed requests | 1–10 | Module default |
...
- [Set-RMMConfig](../commands/Config/Set-RMMConfig.md)
- [Get-RMMConfig](../commands/Config/Get-RMMConfig.md)
- [Save-RMMConfig](../commands/Config/Save-RMMConfig.md)
- [Remove-RMMConfig](../commands/Config/Remove-RMMConfig.md)
