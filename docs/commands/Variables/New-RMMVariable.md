...
Global (Default)
```
New-RMMVariable -Name <String> [-Value <Object>] [-Masked] [-Force] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

BySiteObject
```
New-RMMVariable -Site <DRMMSite> -Name <String> [-Value <Object>] [-Masked] [-Force]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

BySiteUid
```
New-RMMVariable -SiteUid <Guid> -Name <String> [-Value <Object>] [-Masked] [-Force]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
